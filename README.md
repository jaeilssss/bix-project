...
본 프로젝트는 결제 대행사 "나노 바나나 페이먼츠"의 결제 도메인 서버를 주제로 한 백엔드 사전 과제 입니다.

제공된 멀티모듈 + 헥사고날 아키텍처 기반 코드 위에서 결제 생성, 결제 조회(통계포함), 제휴사별 수수료 정책 적용 기능을 구현 했습니다.
